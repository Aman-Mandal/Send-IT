...
const Card = ({ img, name, place, message }) => {
  return (
    <div className="px-6 pointer-events-none py-8  border border-gray-200 rounded-2xl min-w-[18rem] flex flex-col items-center bg-gradient-to-r from-[#40404A] to-[#14131b] my-10 text-white  shadow-lg hover:bg-gray-900">
